...
{{--                        class="dropdown-icon lnr-file-empty"> </i>Graphic Design--}}
{{--                </button>--}}
{{--                <button type="button" tabindex="0" class="dropdown-item"><i--}}
{{--                        class="dropdown-icon lnr-file-empty"> </i>App Development--}}
{{--                </button>--}}
{{--                <button type="button" tabindex="0" class="dropdown-item"><i--}}
{{--                        class="dropdown-icon lnr-file-empty"> </i>Icon Design--}}
{{--                </button>--}}
{{--                <div tabindex="-1" class="dropdown-divider"></div>--}}
{{--                <button type="button" tabindex="0" class="dropdown-item"><i--}}
{{--                        class="dropdown-icon lnr-file-empty"> </i>Miscellaneous--}}
{{--                </button>--}}
{{--                <button type="button" tabindex="0" class="dropdown-item"><i--}}
{{--                        class="dropdown-icon lnr-file-empty"> </i>Frontend Dev--}}
{{--                </button>--}}
{{--            </div>--}}
{{--        </li>--}}
{{--    </ul>--}}
